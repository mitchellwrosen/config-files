...
# Java classpath
export CLASSPATH=/usr/share/java/antlr-complete-3.5.2.jar:$CLASSPATH
...
then
  function hs { ghc -e "interact ($*)"; }
  function hsl { ghc -e "interact (unlines . ($*) . lines)"; }
  function hsw { ghc -e "interact (unwords . ($*) . words)"; }
fi
